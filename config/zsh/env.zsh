...
PATH="/home/ra4ing/perl5/bin${PATH:+:${PATH}}"; export PATH;
PERL5LIB="/home/ra4ing/perl5/lib/perl5${PERL5LIB:+:${PERL5LIB}}"; export PERL5LIB;
PERL_LOCAL_LIB_ROOT="/home/ra4ing/perl5${PERL_LOCAL_LIB_ROOT:+:${PERL_LOCAL_LIB_ROOT}}"; export PERL_LOCAL_LIB_ROOT;
PERL_MB_OPT="--install_base \"/home/ra4ing/perl5\""; export PERL_MB_OPT;
PERL_MM_OPT="INSTALL_BASE=/home/ra4ing/perl5"; export PERL_MM_OPT;
...
__conda_setup="$('/home/ra4ing/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/ra4ing/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/ra4ing/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/ra4ing/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
